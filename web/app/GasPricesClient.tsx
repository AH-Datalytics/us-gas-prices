...
/**
 * Capture a card as a JPEG. Works for the map too: html-to-image serialises a
 * WebGL canvas through toDataURL, which needs the map's drawing buffer to be
 * preserved (see canvasContextAttributes in CountyMap).
 */
